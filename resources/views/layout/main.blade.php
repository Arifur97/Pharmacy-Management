    ...
    <div id="loader"></div>
      ...
      <nav class="side-navbar">
        ...
        <ul id="side-main-menu" class="side-menu list-unstyled">
            <li class="d-none"><a href="{{url('/')}}"> <i class="dripicons-meter"></i><span>{{ __('file.dashboard') }}</span></a></li>
            <?php
            ...
            <li><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-gear"></i><span>{{trans('file.settings')}}</span></a>
                <ul id="setting" class="collapse list-unstyled ">
                    ...
                    @if($role->id <= 2)
                    <li id="role-menu" class="d-none"><a href="{{route('role.index')}}">{{trans('file.Role Permission')}}</a></li>
                    @endif
                    ...
                    @endif
                    <li id="user-menu" class="d-none"><a href="{{route('user.profile', ['id' => Auth::id()])}}">{{trans('file.User Profile')}}</a></li>
                    @if($backup_database_permission_active)
                    <li class=""><a href="{{route('setting.backup')}}">{{trans('file.Backup Database')}}</a></li>
                    @endif
            ...
            <li><a href="#shelfLocation" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-gear"></i><span>{{trans('file.Shelf Location')}}</span></a>
                <ul id="shelfLocation" class="collapse list-unstyled ">
                    <li id="warehouse-menu"><a href="{{route('shelf_location.index')}}">{{trans('file.Shelf Location')}}</a></li>
                </ul>
            </li>
      ...
      <header class="container-fluid">
        <nav class="navbar">
            ...
            <li class="nav-item d-none">
                <a id="switch-theme" data-toggle="tooltip" title="{{trans('file.Switch Theme')}}"><i class="dripicons-brightness-max"></i></a>
            </li>
            <li class="nav-item d-none">
                <a id="btnFullscreen" data-toggle="tooltip" title="{{trans('file.Full Screen')}}"><i class="dripicons-expand"></i></a>
            </li>
